        			...
        			"titles": [
                		{
                			...
                			"display": "五属性の災禍",
                			"monsters": ["jashin_armors"]
                		},
                		{
                			"id": "malucia_thoma",
                			"display": "闇に堕ちた英雄の幻影",
                			"monsters": ["jashin_malucia", "jashin_thoma"]
                		},
                		{
                			"id": "calamity_dream",
                			"display": "災いの神話と暴虐の悪夢",
                			"monsters": ["jashin_calamity", "jashin_dream"]
                		},
                		{
                			"id": "masako_pictures",
                			"display": "魔幻の覇王軍",
                			"monsters": ["jashin_masako", "jashin_pictures"]
                		},
                		{
                			"id": "raz_zel",
                			"display": "覇道の双璧",
                			"monsters": ["jashin_raz", "jashin_zel"]
                		}
        			]
        		},
        		{
        			...
        			"titles": [
                		{
                			"id": "dream_masako",
                			"display": "破壊と創造の神々",
                			"monsters": ["jashin_dream", "jashin_masako"]
                		},
                		{
                			"id": "malucia_masako",
                			"display": "背離する魔族の血統",
                			"monsters": ["jashin_malucia", "jashin_masako"]
                		},
                		{
                			"id": "raz_pictures",
                			"display": "魔宮の守護者たち",
                			"monsters": ["jashin_raz", "jashin_pictures"]
                		},
                		{
                			"id": "dream_thoma",
                			"display": "昏き悪夢の衝撃",
                			"monsters": ["jashin_dream", "jashin_thoma"]
                		},
                		{
                			"id": "calamity_pictures",
                			"display": "災厄神話ギャラリー",
                			"monsters": ["jashin_calamity", "jashin_pictures"]
                		},
                		{
                			"id": "zel_masako",
                			"display": "覇業の君臣",
                			"monsters": ["jashin_zel", "jashin_masako"]
                		},
                		{	"id": "calamity_thoma",
                			"display": "悲劇の英雄譚",
                			"monsters": ["jashin_calamity", "jashin_thoma"]
                		},
                		{
                			"id": "dream_malucia",
                			"display": "見果てぬ夢の蛮勇",
                			"monsters": ["jashin_dream", "jashin_malucia"]
                		},
                		{
                			"id": "thoma_zel",
                			"display": "魔幻の最高幹部",
                			"monsters": ["jashin_thoma", "jashin_zel"]
                		},
                		{
                			"id": "calamity_malucia",
                			"display": "妖女と災獣",
                			"monsters": ["jashin_calamity", "jashin_malucia"]
                		}
        			]
        		}
        	]
